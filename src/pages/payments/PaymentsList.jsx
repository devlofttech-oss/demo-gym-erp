              ...
              return (
                <div key={member.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-rose-100 dark:border-rose-900/30 p-4">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => setMessageMember(member)} className="flex-1 flex items-center justify-center gap-1.5 bg-[#25D366] hover:bg-[#20b558] text-white py-2 rounded-xl text-sm font-semibold transition-colors">
